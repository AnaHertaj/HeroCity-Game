    ...
    with (document) {
        ...
        if (nombreUsuario === null || pwd1 === null || pwd2 === null || emailUsuario === null || dniUsuario === null || nacimientoUsuario === null || pagoIndex === null || condiciones === null){
            ...
            if (textoErrores){
            	...
            	//msg('success', '¡TODO CORRECTO!');

                opener.objPartida.iniciada = true;

                opener.document.getElementById('nombreUsuario').textContent = campoNombre.value;

                const fechaEsp = new Date().toLocaleString('es-ES');

                opener.document.getElementById('fechaPartida').textContent = fechaEsp;

                opener.msg("success", "Partida creada correctamente. ¡A jugar!"); 
